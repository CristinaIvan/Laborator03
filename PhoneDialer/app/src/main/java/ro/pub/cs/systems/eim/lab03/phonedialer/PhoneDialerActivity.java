...
public class PhoneDialerActivity extends AppCompatActivity {
    ...
    private GeneralButtonClickListener generalButtonListener = new GeneralButtonClickListener();
    private class GeneralButtonClickListener implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int index = 0; index < Constants.buttonIds.length; index++) {
            ...
            genericButton.setOnClickListener(generalButtonListener);
        }
    }
}
